...
class SA_XIIController extends Controller
{
    public function store(Request $request)
    {
        ...
        try{
            ...
            if ($request->hasFile('document')) {
                ...
                $validated['document'] = $file->storeAs('SA_Documents/SA_XII', $filename, 'public');
            }
    ...
    //--------------------------update method------------------------------------------------------------------
        ...
        public function update(Request $request, $id)
        {
            ...
            if ($request->hasFile('document')) {
                ...
                $record->Document = $file->storeAs('SA_Documents/SA_XII', $filename, 'public');
            } else {
