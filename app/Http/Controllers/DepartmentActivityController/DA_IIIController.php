...
class DA_IIIController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'total_value_of_books/journals_nvestment(National)'=> 'required|string|max:255',
        ...
        // dd($validated); // For debugging purposes, remove in production
           try{
            ...
            DA_III::create([
                ...
                'Total_Number_of_Journals_Subscribed_National' => $validated['total_number_of_journals_subscribed_international'],

                'Total_Value_of_Books/Journals_Investment(National)' => $validated['datotal_value_of_books/journals_nvestment(Nationalte'],
    ...
    public function update(Request $request, $id)
    {
            ...
            $record->Total_Number_of_Journals_Subscribed_National = $request->input('total_number_of_journals_subscribed_international');

            $record['Total_Value_of_Books/Journals_Investment(National)'] = $request->input('datotal_value_of_books/journals_nvestment(Nationalte');
