...
class DA_IVController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'name_of_VIPs/inspection_commission' => 'required|string|max:255',
           ...
           if ($request->hasFile('document')) {
                ...
                $validated['document'] = $file->storeAs('DA_Documents/DA_IV', $filename, 'public');
            }
        ...
        // dd($validated); // For debugging purposes, remove in production
           try{
            ...
            DA_IV::create([
                'Name_of_VIPs/Inspection_Commission' => $validated['name_of_VIPs/inspection_commission'],
    ...
    public function update(Request $request, $id)
    {
            ...
            // Update fields
            $record['Name_of_VIPs/Inspection_Commission'] = $request->input('name_of_VIPs/inspection_commission');
    ...
    if ($request->hasFile('document')) {
        ...
        $record->Document = $file->storeAs('DA_Documents/DA_IV', $filename, 'public');
    }
    // else → keep old file

            $record->save();

            return redirect()->route('DA.view', ['type' => 'DA_IV'])->with('success', 'Department activity updated successfully');
    }
