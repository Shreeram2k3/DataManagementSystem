...
class FA_IV extends Model
{
    use HasFactory;
    protected $primaryKey='S_NO';
    protected $table = 'FacultyActivity_4';
    protected $fillable = [
        'Date',
        'Name_of_the_Faculty_members',
        'Participated_Presented',
        'Title_of_the_Paper',
        'Page_Numbers',
        'Programme',
        'Conference_Symposium_Training_Programme_Details',
        'Dept',
        'Document_Link',
        'Document',
