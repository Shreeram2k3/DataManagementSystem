    ...
    <form id="facultyForm" method="POST" 
        ...
        <label class="block">
            ...
            <input type="text" name="name_of_the_equipment_failed" required
                value="{{ $record['Name_of_the_Equipment_failed/_Serviced'] ?? old('Name_of_the_Equipment_failed/_Serviced') }}"
                class="w-full border-b border-pink-400 focus:outline-none focus:border-pink-600 py-2">
        </label>

        <label class="block">
            <span class="text-sm text-gray-600">Name of the Lab</span>
            <input type="text" name="name_of_the_lab" required
                value="{{ $record->Name_of_the_Lab ?? old('Name_of_the_Lab') }}"
                class="w-full border-b border-pink-400 focus:outline-none focus:border-pink-600 py-2">
        </label>
        ...
        <label class="block">
            ...
            <input type="text" name="amount_Rs" required
                value="{{ $record->Amount_Rs ?? old('Amount_Rs') }}"
                class="w-full border-b border-pink-400 focus:outline-none focus:border-pink-600 py-2">
        </label>
