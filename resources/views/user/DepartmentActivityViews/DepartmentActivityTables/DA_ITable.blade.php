<thead class="bg-gray-100 text-gray-900 uppercase">
            <tr>
                ...
                <th class="px-4 py-3 border">Details of Equipment </th>
                <th class="px-4 py-3 border">Number of Equipment</th>
                <th class="px-4 py-3 border">Name of Laboratory</th>
                <th class="px-4 py-3 border">Value of the Equipment Rs</th>
            ...
            <tbody class="bg-white">
                <tr class="border-t hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 border">{{ $item->Details_of_Equipment }}</td>
                    <td class="px-4 py-2 border">{{ $item->Number_of_Equipment }}</td>
                    <td class="px-4 py-2 border">{{ $item->Name_of_Laboratory }}</td>
                    <td class="px-4 py-2 border">{{ $item->Value_of_the_Equipment_Rs }}</td>
