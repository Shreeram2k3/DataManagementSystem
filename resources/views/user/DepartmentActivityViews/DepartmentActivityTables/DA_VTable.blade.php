<thead class="bg-gray-100 text-gray-900 uppercase">
            <tr>
                ...
                <th class="px-4 py-3 border">Volume </th>
                <th class="px-4 py-3 border">Release</th>
            ...
            <tbody class="bg-white">
                <tr class="border-t hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 border">{{ $item->Volume }}</td>
                    <td class="px-4 py-2 border">{{ $item->Release }}</td>
