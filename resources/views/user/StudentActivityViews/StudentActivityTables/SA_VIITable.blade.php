<thead class="bg-gray-100 text-gray-900 uppercase">
            <tr>
                ...
                <th class="px-4 py-3 border">Staff(if_guided)</th>
                <th class="px-4 py-3 border">Title of the Paper</th>
                <th class="px-4 py-3 border">Name of the Journal</th>
                <th class="px-4 py-3 border">Volume No</th>
                <th class="px-4 py-3 border">Page No's</th>
                <th class="px-4 py-3 border">Conference Details</th>
            ...
            <tbody class="bg-white">
                <tr class="border-t hover:bg-gray-50">
                  ...
                  <td class="px-4 py-2 border">{{ 
                    $item['Staff(if_guided)']}}</td>
                  <td class="px-4 py-2 border">{{ $item->Title_of_the_Paper}}</td>
                  <td class="px-4 py-2 border">{{ $item->Name_of_the_Journal}}</td>
                  <td class="px-4 py-2 border">{{ $item->Volume_No}}</td>
                  <td class="px-4 py-2 border">{{ $item->Page_Nos}}</td>
                  <td class="px-4 py-2 border">{{ $item->Conference_Details}}</td>
                  <td class="px-4 py-2 border">{{ 
                    $item['National/International']}}</td>  
