<thead class="bg-gray-100 text-gray-900 uppercase">
            <tr>
              ...
              <th class="px-4 py-3 border">Batch</th>

              <th class="px-4 py-3 border">Place</th>
              <th class="px-4 py-3 border">Strength</th>
              <th class="px-4 py-3 border">Remarks / Feedback Received</th>
        ...
        <!-- Check if the data for the selected type is available -->
            ...
            @foreach ($data[$type] as $item)
                <tr class="border-t hover:bg-gray-50">
                      ...
                      <td class="px-4 py-2 border">{{ $item->Strength }}</td>
                      <td class="px-4 py-2 border">{{ $item['Remarks/Feedback_Received'] }}</td>
