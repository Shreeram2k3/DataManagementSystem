<thead class="bg-gray-100 text-gray-900 uppercase">
            <tr>
                ...
                <th class="px-4 py-3 border">Factory Visited</th>
                <th class="px-4 py-3 border">Name of the staff / Students</th>
        ...
        <!-- Check if the data for the selected type is available -->
            ...
            @foreach ($data[$type] as $item)
                <tr class="border-t hover:bg-gray-50">
                      ...
                      <td class="px-4 py-2 border">{{ $item->Factory_Visited }}</td>
                      <td class="px-4 py-2 border">{{ $item['Name_of_the_staff/Students'] }}</td>
                      <td class="px-4 py-2 border">{{ $item->Department }}</td>
                      <td class="px-4 py-2 border">{{ $item->Assessment_Details }}</td>
