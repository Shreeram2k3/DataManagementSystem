<thead class="bg-gray-100 text-gray-900 uppercase">
            <tr>
                ...
                <th class="px-4 py-3 border">Name of the Orgnization</th>
                <th class="px-4 py-3 border">Location</th>
                <th class="px-4 py-3 border">Salary (RS/Annum)</th>
                <th class="px-4 py-3 border">Date of Interview</th>
            ...
            <tbody class="bg-white">
                <tr class="border-t hover:bg-gray-50">
                  <td class="px-4 py-2 border">{{ $item->S_NO}}</td>
                   ...
                   <td class="px-4 py-2 border">{{ $item->Name_of_the_Organization }}</td>
                   <td class="px-4 py-2 border">{{ $item->Location }}</td>
                   <td class="px-4 py-2 border">{{ $item['Salary(Rs/Annum)']}}</td>
                   <td class="px-4 py-2 border">{{ $item->Date_of_Interview}}</td>
