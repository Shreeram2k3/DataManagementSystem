<thead class="bg-gray-100 text-gray-900 uppercase">
            <tr>
                ...
                <th class="px-4 py-3 border">Winter/SummerSchool</th>
                <th class="px-4 py-3 border">Sponsoring_Agency</th>
                <th class="px-4 py-3 border">Title_of_the_Programme</th>
                <th class="px-4 py-3 border">Coordinator</th>
                <th class="px-4 py-3 border">Period</th>
                <th class="px-4 py-3 border">Amount(Rs)</th>
            ...
            <tbody class="bg-white">
                <tr class="border-t hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 border">{{ $item['Winter/SummerSchool'] }}</td>
                    <td class="px-4 py-2 border">{{ $item->Sponsoring_Agency }}</td>
                    <td class="px-4 py-2 border">{{ $item->Title_of_the_Programme }}</td>
                    <td class="px-4 py-2 border">{{ $item->Coordinator }}</td>                     
                    <td class="px-4 py-2 border">{{ $item->Period }}</td>
                    <td class="px-4 py-2 border">{{ $item['Amount(Rs)'] }}</td>
