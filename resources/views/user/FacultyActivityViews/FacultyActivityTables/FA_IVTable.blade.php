<thead class="bg-gray-100 text-gray-900 uppercase">
            <tr>
                ...
                <th class="px-4 py-3 border">Name of the Faculty members</th>
                <th class="px-4 py-3 border">Participated Presented</th>
                <th class="px-4 py-3 border">Title of the Paper</th>
                <th class="px-4 py-3 border">Page Numbers</th>
                <th class="px-4 py-3 border">Programme</th>
                <th class="px-4 py-3 border">Conference/Symposium/Training Programme Details</th>
            ...
            <tbody class="bg-white">
                <tr class="border-t hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 border">{{ $item->Name_of_the_Faculty_members }}</td>
                    <td class="px-4 py-2 border">{{ $item->Participated_Presented }}</td>
