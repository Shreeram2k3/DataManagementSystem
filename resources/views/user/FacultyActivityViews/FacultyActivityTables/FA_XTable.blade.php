<thead class="bg-gray-100 text-gray-900 uppercase">
            <tr>
                ...
                <th class="px-4 py-3 border">Name of Faculty</th>
                <th class="px-4 py-3 border">Topic</th>
                <th class="px-4 py-3 border">Venue(where_delivered)</th>
            ...
            <tbody class="bg-white">
                <tr class="border-t hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 border">{{ $item->Name_of_Faculty }}</td>
                    <td class="px-4 py-2 border">{{ $item->Topic }}</td>
                    <td class="px-4 py-2 border">{{ $item['Venue(where_delivered)'] }}</td>
